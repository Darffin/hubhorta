...
include_once("../funcoes_arquivos.php");
$dirlist = getFileList("../images/uploads"); //em obras
...
echo "<a href='novo_horta.php' class='btn btn-primary' style='white-space: nowrap;'>Novo</a>";
echo "</div>";
...
if (isset($_GET['horta-removida'])) {
	echo "<script>
		Swal.fire({
			position: 'top-end',
			icon: 'success',
			title: 'Horta removida!',
	...
	function confirmarExclusao(id) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = 'remove_horta.php?id=' + id;
			}
		});
	}
